  ...
  export const Card = ({
    ...
    return (
      <div
        ...
        p-3 pb-6 min-h-[217px] min-w-[200px] relative ${disable && "pointer-events-none opacity-50"}`}
      >
        ...
        <Image src={imageSrc} alt={title} className="rounded-lg drop-shadow-md object-cover border" height={70} width={93.33}/>
        <h3 className="text-neutral-700 text-center mt-3 font-bold pt-5">{title}</h3>
